...
namespace Raytracing {
	...
	void RayPipeline::SetRaytracingResource(Tlas arg_tlas)
	{
		...
		DirectX12CmdList::Instance()->cmdList->SetComputeRootConstantBufferView(8, ShockWave::Instance()->m_shockWaveParamData.bufferWrapper->GetGpuAddress());
		...
		DirectX12CmdList::Instance()->cmdList->SetComputeRootConstantBufferView(10, GBufferMgr::Instance()->GetPlayerBuffer().bufferWrapper->GetGpuAddress());
