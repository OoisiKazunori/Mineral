...
void EnemyMgr::GenerateMinekuji(EnemyRoute::ROUTE_ID arg_routeID, bool arg_isTutorialEnemy, bool arg_isTogekuri)
{
	...
	for (auto& index : m_minekujis) {
		...
		index->Generate(EnemyRoute::Instance()->GetRoute(arg_routeID), arg_isTutorialEnemy, arg_isTogekuri);
