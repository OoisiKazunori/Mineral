...
Togekuri::Togekuri()
{
	...
	m_model.LoadOutline("Resource/Enemy/Togekuri/", "Togekuri.gltf");
	/*オカモトゾーン*/
...
void Togekuri::Generate(std::vector<KazMath::Vec3<float>> arg_route, bool arg_isTutorialEnemy)
{
...
void Togekuri::Update(std::weak_ptr<Core> arg_core, std::weak_ptr<Player> arg_player)
{
...
void Togekuri::Draw(DrawingByRasterize& arg_rasterize, Raytracing::BlasVector& arg_blasVec)
{
...
void Togekuri::Damage(std::weak_ptr<Mineral> arg_mineral, int arg_damage)
{
...
void Togekuri::CounterOverlap(KazMath::Vec3<float> arg_centerPos, KazMath::Vec3<float> arg_mineralPos, float arg_scale)
{
...
void Togekuri::AttackCore(std::weak_ptr<Core> arg_core)
{

	switch (m_attackID)
	{
	case Togekuri::ATTACK:
	{
		//移動速度を上げる。
...
void Togekuri::AttackPlayer(std::weak_ptr<Player> arg_player)
{
...
void Togekuri::CheckHitPlayer(std::weak_ptr<Player> arg_player)
{
...
KazMath::Vec3<float> Togekuri::SearchRoute()
{
...
void Togekuri::CheckHit(std::weak_ptr<Player> arg_player) {
...
void Togekuri::Rotation(std::weak_ptr<Core> arg_core, std::weak_ptr<Player> arg_player) {
