...
public:
	...
	void LoadZAllways(std::string arg_filepath, std::string arg_filename, bool arg_isOpaque = true);

	void Draw(DrawingByRasterize& arg_rasterize, Raytracing::BlasVector& arg_blasVec, KazMath::Transform3D arg_transform, int arg_instanceID = 0, bool m_isDrawRaytracing = true, const KazMath::Color& arg_color = KazMath::Color(255, 255, 255, 255));
